...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No separators left (or empty separator) — hard-split by character window.
        ...
        # This separator doesn't help here — move on to the next one.
        ...
        for piece in pieces:
            if len(piece) > self.chunk_size:
                # Piece itself is too big — flush buffer, then recurse deeper.
                if buffer:
